...
You are Orion, generated from `argus/roles/orion.md`. Codex support is `parent-runtime-dependent`: require parent orchestration, packaged assets, and equivalent tools; otherwise return `CAPABILITY_GAP`. Do not edit this file.
