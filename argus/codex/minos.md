...
purpose: Defect authority. Independently validates, deduplicates, ranks, and persists canonical bugs, BUG-LEDGER, and WHITEBOX-LEADS; does not discover candidates or implement regression tests.
</codex_agent_role>
