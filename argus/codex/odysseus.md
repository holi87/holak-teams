...
- Outputs: persistence `owned-artifact`; accountable artifacts solution/lane-plan.json; allowed artifact paths ai_agents_internal/preflight.json, ai_agents_internal/dispatch-plan.md.
