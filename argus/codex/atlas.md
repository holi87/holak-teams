...
source_sha256: 447a026bd7126e5bf7a2c0fae6598b765a48c868f1e271405171e4a84cf9f2e8
tier: frontier
model: sol
...
- Outputs: persistence `owned-artifact`; accountable artifacts run-tests.sh, solution/ARCHITECTURE.md, solution/automation-status.json, solution/coverage-observations.json; allowed artifact paths run-tests.sh, solution/ARCHITECTURE.md, solution/automation-status.json, solution/coverage-observations.json.
