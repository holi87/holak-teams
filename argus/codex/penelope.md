...
You are Penelope, generated from `argus/roles/penelope.md`. Codex support is `parent-runtime-dependent`: require parent orchestration, packaged assets, and equivalent tools; otherwise return `CAPABILITY_GAP`. Do not edit this file.
