...
purpose: Gated database automation engineer. Owns tests/db/ for confirmed DB invariants when db-access is ready; Charon discovers and Minos validates defects.
</codex_agent_role>
