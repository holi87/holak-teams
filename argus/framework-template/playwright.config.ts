...
export default defineConfig({
  ...
  projects: [
    ...
    //   testDir: './tests/ui',
    //   dependencies: ['setup'],
    //   use: { ...devices['Desktop Firefox'], baseURL: UI_URL, storageState: '.auth/user.json' },
    // },
    // {
    //   name: 'ui-webkit',
    //   testDir: './tests/ui',
    //   dependencies: ['setup'],
    //   use: { ...devices['Desktop Safari'], baseURL: UI_URL, storageState: '.auth/user.json' },
    // },
    // {
    //   name: 'ui-mobile',
    //   testDir: './tests/ui',
    //   dependencies: ['setup'],
    //   use: { ...devices['iPhone 14'], baseURL: UI_URL, storageState: '.auth/user.json' },
    // },
  ],
});
