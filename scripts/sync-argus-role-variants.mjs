...
assert(adapters.schemaVersion === 1, 'runtime adapter schemaVersion must be 1');
...
function bootstrap() {
  ...
  writeJson(ADAPTERS_PATH, {
    ...
    codex: {
      ...
      doctrinePolicy: 'embed the canonical doctrine because standalone Codex agents cannot preload Claude plugin skills',
